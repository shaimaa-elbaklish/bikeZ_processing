...
plot_line_latlon(m, centerline_coords_list[0], 'label', linecolor='black', lineweight=5,
...
langstrasse_NS_branch = []
for i in [14, 0, 3, 9]:
    if len(langstrasse_NS_branch) == 0:
        langstrasse_NS_branch = centerline_coords_list[i]
        continue
    if langstrasse_NS_branch[-1] == centerline_coords_list[i][0]:
        langstrasse_NS_branch = langstrasse_NS_branch + centerline_coords_list[i][1:]
    else:
        langstrasse_NS_branch = langstrasse_NS_branch + centerline_coords_list[i]
